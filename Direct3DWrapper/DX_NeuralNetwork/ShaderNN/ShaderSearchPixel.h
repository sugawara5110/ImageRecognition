...
"   uint outpx = inid.x;\n"
"   uint outpy = inid.y;\n"
"   uint outbwidNum = gInpixWH_OutpixWH.z / gseapixWH_step.x;\n"
"   uint outInd = gInpixWH_OutpixWH.z * outpy + outpx;\n"
"   uint outbxInd = outpx / gseapixWH_step.x;\n"
"   uint outbyInd = outpy / gseapixWH_step.y;\n"
"   uint blockInd = outbwidNum * outbyInd + outbxInd;\n"
"   uint bx = outpx % gseapixWH_step.x;\n"
"   uint by = outpy % gseapixWH_step.y;\n"
...
"   uint stx = gInPixPos[blockInd].stW;\n"
"   uint sty = gInPixPos[blockInd].stH;\n"
"   uint enx = gInPixPos[blockInd].enW;\n"
"   uint eny = gInPixPos[blockInd].enH;\n"

"   if(gNNoutput[blockInd] > 0.7f && \n"
"           (\n"
